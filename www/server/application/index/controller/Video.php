...
class Video extends Controller
{
   ...
   public function advert()
    ...
    public function index()
    {
        ...
        $list       =   db('video')->order('id desc')->paginate(30);
        return view('index',[
            'msg'   =>  $msg,
            'list'  =>  $list,
            'code'  =>  $code
    ...
    public function del()
    {
        $data   =   db('video')->where('id',input('id'))->delete();
    ...
    public function create()
    {
        ...
        if($file){
            ...
            if($info){
                ...
                $url    =   'http://www.xv3l.cn/public/uploads/'. $info->getSaveName();
                ...
                return redirect('video/add',['code'=>0,'msg'=>'上传失败'.$file->getError()]);
            }
        }else{
