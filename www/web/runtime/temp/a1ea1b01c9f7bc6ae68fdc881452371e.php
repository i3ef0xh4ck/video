<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:72:"/www/wwwroot/jiexi.monocon.com.cn/application/index/view/user/index.html";i:1517303560;s:68:"/www/wwwroot/jiexi.monocon.com.cn/application/index/view/layout.html";i:1534126742;}*/ ?>
<!DOCTYPE html>
<html lang="zh-CN">
<head>
    <meta charset="utf-8">
            ...
            <div class="panel-body">
                ...
                <div class="table-responsive" data-pattern="priority-columns" data-focus-btn-icon="fa-asterisk"
                    ...
                    <div style="text-align: center">
                        ...
                        <hr>
                        <textarea class="form-control" placeholder="&nbsp输入邀请码/代理账号" type="text" name="key" style="height: 38px"></textarea>
...
<?php }?>
   ...
   <td><?php echo $vo['sign']; ?></td>
                            <?php if(session('power')=='0'){?>
                            <td>
                                <a target="_Blank" href="/index/user/index.php?parentid=<?php echo $vo['id']; ?>"> <?php echo getusercount($vo['id']); ?></a>
                            </td>
                            <td>
                                <a target="_Blank" href="/index/vip/index.php?parentid=<?php echo $vo['id']; ?>"><?php echo getvipcount($vo['id']); ?></a>
                            </td>
                            <td>
