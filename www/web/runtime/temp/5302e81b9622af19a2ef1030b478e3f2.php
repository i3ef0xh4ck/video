<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:75:"/www/wwwroot/jiexi.monocon.com.cn/application/index/view/banner/update.html";i:1506735224;s:68:"/www/wwwroot/jiexi.monocon.com.cn/application/index/view/layout.html";i:1534126742;}*/ ?>
<!DOCTYPE html>
<html lang="zh-CN">
<head>
    <meta charset="utf-8">
    ...
    <div class="breadcrumb-env">
        ...
        <ol class="breadcrumb bc-1">
            ...
            <li>
                ...
                <a href="<?php echo url('banner/index'); ?>">Banner</a>
            </li>
            <li class="active">
    ...
    <div class="panel-body">
        ...
        <form role="form" id="form1"  method="post" action="<?php echo url('banner/edit'); ?>" enctype="multipart/form-data" class="validate">
            ...
            <div class="form-group">
                ...
                <input type="text" class="form-control" name="content" value="<?php echo $data['content']; ?>"  placeholder="" />
            </div>

            <div class="form-group">
                <label class="control-label">跳转链接</label>

                <input type="text" class="form-control" name="linkurl" value="<?php echo $data['linkurl']; ?>"  placeholder="" />
            </div>
