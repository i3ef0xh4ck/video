<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:67:"/www/wwwroot/jiexi.monocon.com.cn/application/app/view/index/m.html";i:1534075194;}*/ ?>
    ...
    $('.down').click(function(){
        ...
        if(isAndroid)
        {
            ...
            if(weixin){
                ...
                window.location.href="http://app.monocon.com.cnm/zhuijuba.apk";
            }
        }else{

            window.location.href="http://app.monocon.com.cn/app/index/ios.html";
        }
    });
