<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:71:"/www/wwwroot/app.chengxuxiang.com/application/app/view/index/qudao.html";i:1529685252;}*/ ?>
<!doctype html>
...
<script type="text/javascript">
  function getZce() {
    ...
    $.ajax({
      type: "GET",
      url: "http://app.chengxuxiang.com/login/login/zce.html",
  ...
  function tourl(){
    window.location.href='http://app.chengxuxiang.com/app/index/m.html';
  }
</script>
</html>
