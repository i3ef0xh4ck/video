<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:73:"/www/wwwroot/jiexi.monocon.com.cn/application/index/view/user/update.html";i:1506735606;s:68:"/www/wwwroot/jiexi.monocon.com.cn/application/index/view/layout.html";i:1534073907;}*/ ?>
<!DOCTYPE html>
<html lang="zh-CN">
<head>
    <meta charset="utf-8">
    ...
    <div class="breadcrumb-env">
        ...
        <ol class="breadcrumb bc-1">
            ...
            <li>
                ...
                <a href="<?php echo url('user/index'); ?>">User</a>
            </li>
            <li class="active">
...
<div class="panel panel-default">
    ...
    <div class="panel-body">
        ...
        <form role="form" id="form1" method="post" action="<?php echo url('user/update'); ?>" class="validate">
            ...
            <div class="form-group">
                ...
                <input type="text" class="form-control" name="phone"  value="<?php echo $data['phone']; ?>"  placeholder="QQ或者微信" />
            </div>
            ...
            <div class="form-group">
                <label class="control-label">身份</label>
                    ...
                    <select name="power" class="form-control">
                        <option value="1" <?php echo !empty($data['power']) && $data['power']=='1'?'selected':''; ?>>代理</option>
                        <option value="2" <?php echo !empty($data['power']) && $data['power']=='2'?'selected':''; ?>>用户</option>
            ...
            <div class="form-group">
                <label class="control-label">推荐码</label>
                <input type="text" class="form-control" value="<?php echo $data['share_ma']; ?>" disabled />
            </div><?php }?>
