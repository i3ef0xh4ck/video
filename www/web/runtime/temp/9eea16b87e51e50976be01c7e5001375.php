<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:71:"/www/wwwroot/jiexi.monocon.com.cn/application/index/view/user/clog.html";i:1502087476;s:68:"/www/wwwroot/jiexi.monocon.com.cn/application/index/view/layout.html";i:1534126742;}*/ ?>
<!DOCTYPE html>
<html lang="zh-CN">
<head>
    <meta charset="utf-8">
        ...
        <div class="panel panel-default">
            ...
            <div class="panel-body">
                <div style="text-align: center">
                    <form class="validate" method="get" action="<?php echo url('user/clog'); ?>">
                        到期时间: <input class="form-control" type="date" name="start" >&nbsp;-&nbsp;<input class="form-control" type="date" name="end" >&nbsp;&nbsp;&nbsp;&nbsp;
                        <hr>
                        <input class="form-control" placeholder="&nbsp;代理账户关键词" type="text" name="user" style="height: 38px">
                        <hr>
                        <input class="form-control" placeholder="&nbsp;用户账户关键词" type="text" name="vip" style="height: 38px">
