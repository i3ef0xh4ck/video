<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:73:"/www/wwwroot/app.chengxuxiang.com/application/index/view/admin/index.html";i:1517303560;s:68:"/www/wwwroot/app.chengxuxiang.com/application/index/view/layout.html";i:1529685268;}*/ ?>
<!DOCTYPE html>
<html lang="zh-CN">
<head>
    <meta charset="utf-8">
                ...
                <div class="table-responsive" data-pattern="priority-columns" data-focus-btn-icon="fa-asterisk"
                    ...
                    <table cellspacing="0" class="table table-small-font table-bordered table-striped">
                        ...
                        <tr>
                            ...
                            <td>
                                <a  href="<?php echo url('admin/update',['id'=>$vo['id'],'page'=>input('page')]); ?>" title="修改"> <i class="el-edit"></i></a>
                                &nbsp;
