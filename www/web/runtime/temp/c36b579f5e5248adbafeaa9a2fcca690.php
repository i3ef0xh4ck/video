<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:67:"/www/wwwroot/app.chengxuxiang.com/application/app/view/index/m.html";i:1529685262;}*/ ?>
    ...
    $('.down').click(function(){
        ...
        if(isAndroid)
        {
            ...
            if(weixin){
                ...
                window.location.href="http://go.chengxuxiang.com/moshengys.apk";
            }
        }else{

            window.location.href="http://app.chengxuxiang.com/app/index/ios.html";
        }
    });
