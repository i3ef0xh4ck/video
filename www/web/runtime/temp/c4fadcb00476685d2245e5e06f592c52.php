<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:70:"/www/wwwroot/jiexi.monocon.com.cn/application/index/view/user/add.html";i:1506735610;s:68:"/www/wwwroot/jiexi.monocon.com.cn/application/index/view/layout.html";i:1529685268;}*/ ?>
<!DOCTYPE html>
<html lang="zh-CN">
<head>
    <meta charset="utf-8">
    ...
    <div class="panel-body">
        ...
        <form role="form" id="form1" method="post" action="<?php echo url('user/add'); ?>" class="validate">
            ...
            <div class="form-group">
                ...
                <input type="text" class="form-control" name="phone" data-validate="required" data-message-required="联系方式必填" placeholder="QQ或者微信" />
            </div>
            <?php if(session('power')=='1'){?>
            <div class="form-group">
