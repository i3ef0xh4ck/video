<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:60:"/www/wwwroot/go.itlinux.cn/application/app/view/index/m.html";i:1528290646;}*/ ?>
    ...
    $('.down').click(function(){
        ...
        if(isAndroid)
        {
            ...
            if(weixin){
                ...
                window.location.href="http://gxys.oss-cn-hangzhou.aliyuncs.com/gxys.apk";
            }
        }else{
          
            window.location.href="http://go.itlinux.cn/app/index/ios.html";
        }
    });
