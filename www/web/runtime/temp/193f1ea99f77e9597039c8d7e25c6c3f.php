<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:74:"/www/wwwroot/jiexi.monocon.com.cn/application/index/view/banner/index.html";i:1506734856;s:68:"/www/wwwroot/jiexi.monocon.com.cn/application/index/view/layout.html";i:1534126742;}*/ ?>
<!DOCTYPE html>
<html lang="zh-CN">
<head>
    <meta charset="utf-8">
  ...
  <div class="table-responsive" data-pattern="priority-columns" data-focus-btn-icon="fa-asterisk"
                    ...
                    <table cellspacing="0" class="table table-small-font table-bordered table-striped">
                        ...
                        <tr>
                            ...
                            <th >
                                <img style="width: 100px; height: 100px" src="<?php echo $vo['picurl']; ?>">
                            </th>
                            <th >
                                <?php echo $vo['content']; ?>
                            </th>
                           ...
                           <th style=" text-align: center;"> <a href="<?php echo url('banner/update',['id'=>$vo['id']]); ?>" title="修改" > <i class="el-edit"></i></a>
                               &nbsp;
                               <a href="<?php echo url('banner/del',['id'=>$vo['id']]); ?>" title="删除" class=btn-single"><i class="el-trash-circled"></i></a></th>
