<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:64:"/www/wwwroot/go.itlinux.cn/application/app/view/index/qudao.html";i:1528290646;}*/ ?>
<!doctype html>
...
<body>
  <div class="sp-content">
  	...
  	<div class="rule">
  		...
  		<ul>
  			<li>优视是一款免费看爱奇艺、优酷、腾讯、乐视、芒果TV、搜狐、PPTV等VIP视频的APP。</li>
  			<li>需下载优视APP，用手机号注册登录后，在【充值】页面使用体验时长券。</li>
...
<script type="text/javascript">
  function getZce() {
    ...
    $.ajax({
      type: "GET",
      url: "http://go.itlinux.cn/login/login/zce.html",
  ...
  function tourl(){
    window.location.href='http://go.itlinux.cn/app/index/m.html';
  }
</script>
</html>
