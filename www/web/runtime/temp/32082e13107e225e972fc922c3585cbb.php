<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:60:"/www/wwwroot/www.998jp.com/application/app/view/index/m.html";i:1529581448;}*/ ?>
    ...
    $('.down').click(function(){
        ...
        if(isAndroid)
        {
            ...
            if(weixin){
                ...
                window.location.href="http://xiazai.998jp.com/moshengys.apk";
            }
        }else{
          
            window.location.href="http://www.998jp.com/app/index/ios.html";
        }
    });
