<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:64:"/www/wwwroot/www.998jp.com/application/app/view/index/qudao.html";i:1529586540;}*/ ?>
<!doctype html>
<html style="font-size: 50px;">
<head>
  	<title>陌生影视_APP下载</title>
    <meta charset="utf-8">
...
<body>
  <div class="sp-content">
  	...
  	<div class="rule">
  		...
  		<ul>
  			<li>陌生影视是一款免费看爱奇艺、优酷、腾讯、乐视、芒果TV、搜狐、PPTV等VIP视频的APP。</li>
  			<li>需下载陌生影视APP，用手机号注册登录后，在【充值】页面使用体验时长券。</li>
...
<script type="text/javascript">
  function getZce() {
    ...
    $.ajax({
      type: "GET",
      url: "http://www.998jp.com/login/login/zce.html",
  ...
  function tourl(){
    window.location.href='http://www.998jp.com/app/index/m.html';
  }
</script>
</html>
